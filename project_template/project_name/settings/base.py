...
Generated by https://github.com/evgkirov/create-django-project using Django {{ django_version }}.
...
DATABASES = {
    "default": env.db(
        default="postgres://{{ project_name }}:{{ project_name }}@db:5432/{{ project_name }}"
    )
}
